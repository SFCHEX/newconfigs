...
static const char *brightnessdowncmd[]  = { "/bin/sh", "-c","brightnessctl --min-value=10000 s 7%- ; pkill -RTMIN+20 dwmblocks",  NULL };

static const char *brightnessupcmd[]  = { "/bin/sh", "-c","brightnessctl s +7% ; pkill -RTMIN+20 dwmblocks",  NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          {.v = browser1cmd } },
	{ MODKEY,                       XK_g,      spawn,          {.v = browser2cmd } },
	{ MODKEY,                       XK_a,      spawn,          {.v = browser3cmd } },
